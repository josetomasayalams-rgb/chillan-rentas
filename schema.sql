...
-- Acceso temporal por PIN solicitado para Operaciones. El login de correo se
-- reemplaza por Cloudflare cuando estén confirmados todos los participantes.
-- Mientras tanto el cliente público necesita leer y escribir con el rol anon.
create or replace function public.log_calendar_change()
returns trigger
language plpgsql
security definer
